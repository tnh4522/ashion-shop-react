                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="breadcrumb__links">
                                ...
                                <Link className="breadcrumb__item" to="/blog"><i className="fa fa-home"></i> Blog</Link>
                        ...
                        <div className="col-lg-8 col-md-8">
                            <div className="blog__details__content">
                                <div className="blog__details__item">
                                    <img src="/ashion-master/img/blog/details/blog-details.jpg" alt=""/>
                                    <div className="blog__details__item__title">
                                        <span className="tip">Street style</span>
                                        <h4>Being seen: how is age diversity effecting change in fashion and
                                            beauty?</h4>
                                        <ul>
                                ...
                                <div className="blog__details__desc">
                                    <p>Afashion season can be defined as much by the people on the catwalk as it can by
                                        the
                                        clothes they are wearing. This time around, a key moment came at the end of Marc
                                        Jacobs’
                                        New York show, when an almost makeup-free Christy Turlington made a rare return
                                        to the
                                        catwalk, aged 50 (she also stars, with the designer himself, in the label’s AW
                                        ad
                                        campaign), where the average catwalk model is around 18.</p>
                                    <p>A few days later, Simone Rocha arguably upped the ante. The 32-year-old’s show –
                                        in part
                                        inspired by Louise Bourgeois, who lived until she was 98 – featured models in
                                        their 30s
                                ...
                                <div className="blog__details__quote">
                                    ...
                                    <p>Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore dolore
                                        magna
                                ...
                                <div className="blog__details__desc">
                                    <p>Occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim
                                        id est
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6 col-md-6 col-sm-6">
                                            <div className="blog__details__btn__item">
                                                <h6><a href="#"><i className="fa fa-angle-left"></i> Previous posts</a>
                                                </h6>
                                            </div>
                                        </div>
                                        <div className="col-lg-6 col-md-6 col-sm-6">
                                            <div className="blog__details__btn__item blog__details__btn__item--next">
                                                <h6><a href="#">Next posts <i className="fa fa-angle-right"></i></a>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="blog__details__comment">
                                    ...
                                    <div className="blog__comment__item">
                                        <div className="blog__comment__item__pic">
                                            <img src="/ashion-master/img/blog/details/comment-1.jpg" alt=""/>
                                        </div>
                                    ...
                                    <div className="blog__comment__item blog__comment__item--reply">
                                        <div className="blog__comment__item__pic">
                                            <img src="/ashion-master/img/blog/details/comment-2.jpg" alt=""/>
                                        </div>
                                        <div className="blog__comment__item__text">
                                            <h6>Brandon Kelley</h6>
                                            <p>Consequat consetetur dissentiet, ceteros commune perpetua mei et. Simul
                                                viderer
                                    ...
                                    <div className="blog__comment__item">
                                        <div className="blog__comment__item__pic">
                                            <img src="/ashion-master/img/blog/details/comment-3.jpg" alt=""/>
                                        </div>
                                        <div className="blog__comment__item__text">
                                            <h6>Brandon Kelley</h6>
                                            <p>Duis voluptatum. Id vis consequat consetetur dissentiet, ceteros commune
                                ...
                                <div className="blog__sidebar__item">
                                    ...
                                    <a href="#" className="blog__feature__item">
                                        <div className="blog__feature__item__pic">
                                            <img src="/ashion-master/img/blog/sidebar/fp-1.jpg" alt=""/>
                                        </div>
                                    ...
                                    <a href="#" className="blog__feature__item">
                                        <div className="blog__feature__item__pic">
                                            <img src="/ashion-master/img/blog/sidebar/fp-2.jpg" alt=""/>
                                        </div>
                                        <div className="blog__feature__item__text">
                                            <h6>Amf Cannes Red Carpet Celebrities Kend...</h6>
                                            <span>Seb 17, 2019</span>
                                    ...
                                    <a href="#" className="blog__feature__item">
                                        <div className="blog__feature__item__pic">
                                            <img src="/ashion-master/img/blog/sidebar/fp-3.jpg" alt=""/>
                                        </div>
                                        <div className="blog__feature__item__text">
                                            <h6>Amf Cannes Red Carpet Celebrities Kend...</h6>
                                            <span>Seb 17, 2019</span>
